...
fn get_each_minute_spent_asleep_per_guard(records: &[Record]) -> HashMap<GuardId, HashMap<Minute, u32>> {
    ...
    for record in records {
        match record.event {
            ...
            GuardEvent::WakeUp => {
                ...
                let mut m = minutes_spent_asleep.entry(guard_id).or_insert(HashMap::new());
